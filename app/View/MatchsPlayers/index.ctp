<div class="matchsPlayers index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('lastame'); ?></th>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($matchsPlayer['Player']['lastname'], array('controller' => 'players', 'action' => 'view', $matchsPlayer['Player']['id'])); ?>
		</td>
		<td>
